                ...
                <div
                    ...
                    <div className="flex-1 py-4 px-4 sm:p-10 flex flex-col justify-center items-start">
                        ...
                        <p className="text-left mb-4 font-serif text-base sm:text-lg">
                            Neben <strong>klassischen Gesichtsbehandlungen</strong> von REVIDERM, Valmont und Susanne
                            Kaufmann bieten wir Ihnen auch spezielle <strong>Anti-Aging Behandlungen</strong> wie das
                            Microneedling, HydraFacial, Fruchtsäurepeelings oder hochwirksame Ultraschall-Treatments an.
                            Permanent Make-up, Wimpernlifting, Maniküre/Pediküre und Haarentfernung runden Ihr
                            Schönheitsprogramm ab. Unser Team kümmert sich aber nicht nur um das Gesicht, sondern auch
                            um den perfekten Body. Zum Beispiel mit der LPG Endermologie® zur Bekämpfung von Cellulite
                            und zur Körperstraffung.
                        </p>
                        ...
                        <div className="absolute inset-0">
                            ...
                            >
                                <div className="bg-white rounded-full p-4">
                                    <svg className="text-primary w-10 h-10" xmlns="http://www.w3.org/2000/svg"
